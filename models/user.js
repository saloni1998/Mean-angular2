...
const passwordValidators = [
  ...
  //Second password validator
  {
    ...
    message: 'Password must have at least one uppercase, lowercase, a special character and a number'
  }
];
...
userSchema.pre('save', function(next) {
  ...
  // Apply encryption
  // add this in api to generate hash and salt

    var salt = genRandomString(16);
    var passwordData = sha(this.password,salt);
...
userSchema.methods.comparePassword = function(userpassword) {
      ...
      var userdata=sha(userpassword,this.salt);
      // console.log('salt',this.salt);
      // console.log('new hashed pass',userdata.passwordHash);
      return userdata.passwordHash==this.password; // Return comparison of login password to password in database (true or false)
};
